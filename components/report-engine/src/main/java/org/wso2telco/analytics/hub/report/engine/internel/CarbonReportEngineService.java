...
class ZipReportEngineGenerator implements Runnable {
    ...
    public ZipReportEngineGenerator(String carbonHome, String path, String[] fileNames, String user, String
            reportType) {
        ...
        for (String accountId : userNames) {
          //  String accountId = getKillBillAccount(tenantId, username);
            ...
            if (invoiceForMonth != null) {
                ...
                DetailReportAlert report = new DetailReportAlert();
                report.setPayment(finalAmount);
