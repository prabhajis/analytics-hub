...
/**
 * Stream processor for Wallet API
 */
public class WalletAPIStreamProcessor extends StreamProcessor {

    private static final String LIST_TRANSACTIONS = "listTransactions";
            ...
            synchronized (this) {
                ...
                while (streamEventChunk.hasNext()) {
                    ...
                    try {
                        ...
                        if (function.equals(LIST_TRANSACTIONS)) {
